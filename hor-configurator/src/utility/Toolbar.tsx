...
export const Toolbar = ({ state, editorVisible, setState, setEditorVisibility }: { state: Warband; editorVisible: boolean; setState(json: any): void; setEditorVisibility(visible: any): void }) => <div>
